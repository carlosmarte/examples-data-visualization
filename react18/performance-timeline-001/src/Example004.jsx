        ...
        >
          ...
          <Bar dataKey="blockingTime" stackId="a" fill={colors.blockingTime}>
            <LabelList
              ...
              content={(props) => (
                <VerticalLabel {...props} name="Total Blocking Time" />
              )}
            />
          </Bar>
          ...
          <Bar dataKey="fid" stackId="a" fill={colors.fid}>
            <LabelList
              dataKey="fid"
              content={(props) => (
                <VerticalLabel {...props} name="First Input Delay" />
              )}
            />
          </Bar>
          ...
          <Bar dataKey="cls" stackId="a" fill={colors.cls}>
            <LabelList
              dataKey="cls"
              content={(props) => (
                <VerticalLabel {...props} name="Layout Shift" />
              )}
            />
          </Bar>
          ...
          >
            <LabelList
              dataKey="timeToInteractive"
              content={(props) => (
                <VerticalLabel {...props} name="Time to Interactive" />
              )}
            />
          </Bar>
        </BarChart>
